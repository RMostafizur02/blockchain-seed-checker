...
// BIP39EnglishWordlist contains the 2048 words for BIP-39 mnemonics
...
// GetWordlist returns a copy of the BIP-39 English wordlist
func GetWordlist() []string {
	wordlist := make([]string, len(BIP39EnglishWordlist))
	copy(wordlist, BIP39EnglishWordlist)
	return wordlist
}
